...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-gray-200 dark:border-gray-800">
      <SidebarHeader className="border-b border-gray-200 dark:border-gray-800 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="hover:bg-white/50 dark:hover:bg-gray-800/50 transition-all duration-200">
              <Link href="/admin/dashboard" className="group">
                <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-linear-to-br from-blue-600 to-blue-700 text-white shadow-md group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
                  <Building2 className="size-4" />
                </div>
                <div className="flex flex-col gap-0.5 leading-none">
                  <span className="font-bold text-gray-900 dark:text-white">AI-HRMS</span>
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton
                  size="lg"
                  className="data-[state=open]:bg-blue-50 dark:data-[state=open]:bg-blue-950/30 data-[state=open]:text-blue-700 dark:data-[state=open]:text-blue-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 group"
                >
                  <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-linear-to-br from-purple-600 to-pink-600 text-white shadow-md group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
              ...
              <DropdownMenuContent
                ...
                sideOffset={4}
              >
                <DropdownMenuItem asChild className="hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors duration-150 cursor-pointer">
